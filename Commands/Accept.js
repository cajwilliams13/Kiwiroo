    ...
    execute(message, args, db) {
        ...
        if (name === "undefined") {
            ...
            fs.writeFile(`./Characters/${name}/status.txt`, "Approved", (err) => {
                message.client.channels.get("604615487950946326").send(`${name} [created by ${owner}] has been approved by ${message.author}. Placing completed character in <#597312122581680148>.`)
                ...
                message.client.channels.get("597312122581680148").send({ embed: Character });
            });
            });
            });
            });
