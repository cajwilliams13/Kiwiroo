...
module.exports = {
    ...
    execute(message) {
        ...
        //         message.channel.send(`What is ${a}'s primary fire damage/healing? [per shot]`)
        ...
        //         message.channel.send(`What is ${a}'s alternate fire damage/healing? [per shot]`)
        ...
        //         message.channel.send(`What is ${a}'s 1st ability [F] damage/healing? [per shot]`)
        ...
        //         message.channel.send(`What is ${a}'s 2nd ability [Q] damage/healing? [per shot]`)
